...
const CARD_CONTENT_HEIGHT = 320     // fixed px height for the text area
const FONT_MAX = 1.5                // rem — short-message size (unchanged from before)
const FONT_MIN = 0.75               // rem — hard floor, still legible
const FONT_STEP = 0.05              // rem — shrink granularity
        ...
        >
          ...
          <div ref={shareWrapperRef} className="p-4 bg-transparent">
            <div className="w-full rounded-[2.5rem] overflow-hidden shadow-2xl bg-white border border-gray-100">
              ...
              <div
                className="relative px-8 flex flex-col items-center justify-center bg-white"
