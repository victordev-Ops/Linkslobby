...
const CARD_CONTENT_HEIGHT = 440     // fixed px height for the text area
        ...
        >
          ...
          <div ref={shareWrapperRef} className="p-4 bg-transparent">
            <div className="w-full rounded-[2.5rem] overflow-hidden shadow-2xl bg-white border border-gray-100">
              ...
              <div
                className="relative px-6 flex flex-col items-center justify-center bg-white overflow-hidden"
