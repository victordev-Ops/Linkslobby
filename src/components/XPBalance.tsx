    ...
    <div className="relative z-50">
      ...
      <div className="relative group">
        ...
        <motion.button
          ...
          className="relative flex items-center gap-1.5 bg-white/20 dark:bg-white/[0.07] backdrop-blur-2xl border border-white/60 dark:border-white/15 px-3 py-1.5 rounded-md shadow-[0_4px_18px_rgba(0,0,0,0.10)] overflow-hidden min-w-fit"
