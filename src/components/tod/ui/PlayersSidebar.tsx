import { Sparkles, Flame, Crown, CheckCircle2, Skull } from 'lucide-react';
...
export const PlayersSidebar = ({
  ...
  const gameEvents = messages.filter(
    m => m.message_type === 'system' || m.message_type === 'truth' || m.message_type === 'dare'
  ).slice(-10);
