...
// Compact version - works well above chat input
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            ...
            className="group px-4 sm:px-6 py-3 sm:py-4 bg-orange-500/20 border-2 border-orange-500 text-orange-300 rounded-xl font-black text-sm sm:text-base hover:bg-orange-500 hover:text-white transition-all active:scale-95 flex items-center gap-2 backdrop-blur-sm"
          >
          ...
          <button
            ...
            className="group px-4 sm:px-6 py-3 sm:py-4 bg-red-500/20 border-2 border-red-500 text-red-300 rounded-xl font-black text-sm sm:text-base hover:bg-red-500 hover:text-white transition-all active:scale-95 flex items-center gap-2 backdrop-blur-sm"
          >
