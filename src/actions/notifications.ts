...
// Keeping this map in one place — and using it consistently on both the write side here
// and the count-read side in NotificationContext's refreshUnreadCount — is what was
// missing before. The write side and the count-read side used different keys/tables,
// so a "hidden" notification kept counting toward the unread badge.
