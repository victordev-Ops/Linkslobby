        ...
        <div className={`${display.variable} ${body.variable} min-h-screen bg-black text-white font-[family-name:var(--font-body)]`}>
            ...
            <div className="h-44 sm:h-56 relative bg-gradient-to-br from-neutral-900 via-neutral-950 to-black overflow-hidden">
                ...
                <div className="absolute top-4 right-4 flex items-center gap-1.5 z-10">
                    <XPBalance />
                    {isOwnProfile && (
                        <label className="flex items-center gap-1.5 px-3 py-2 bg-black/40 backdrop-blur-md border border-white/10 rounded-full hover:bg-black/60 transition cursor-pointer text-xs font-bold">
                            <Camera size={14} />
                            Edit cover
                            <input
                                type="file"
