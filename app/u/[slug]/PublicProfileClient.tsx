...
import { ArrowLeft, MessageSquare, Calendar, UserPlus, Loader2, Check, X, Camera } from 'lucide-react'
            ...
            <div className="max-w-lg mx-auto px-4 -mt-14 relative z-10">
                ...
                <div className="mb-6">
                    <div className="flex items-center gap-1.5">
                        <h1 className="text-2xl font-black tracking-tight font-[family-name:var(--font-display)]">{profile.username}</h1>
                        {profile.is_pro ? (
                            <VerifiedBadge size={20} />
                        ) : isOwnProfile && (
                            <Link href="/upgrade" className="inline-flex items-center gap-1 text-[11px] font-bold text-white hover:text-white/80 transition bg-white/10 border border-white/10 px-2 py-0.5 rounded-full">
                ...
                <div className="flex gap-4 mb-8">
                    <div className="flex-1 bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center justify-center">
                        <XPBalance />
                    </div>
                </div>
