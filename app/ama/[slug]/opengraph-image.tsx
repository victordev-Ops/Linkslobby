// app/ama/[slug]/opengraph-image.tsx
import { ImageResponse } from 'next/og'

export const alt = 'Ask me anything — anonymous questions'
...
export default async function Image() {
  const wordmark = 'AMA'
  const tagline = 'Ask me anything, anonymously'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Question-mark motif, echoing the app's chat-bubble icon */}
        <div
          style={{
            position: 'absolute',
            top: 64,
