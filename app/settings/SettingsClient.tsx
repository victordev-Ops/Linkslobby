...
// Same two-role type system as the dashboard: Space Grotesk for
// headings/wordmark-style labels, Inter for body copy.
...
export default function SettingsClient({
    ...
    <div className="fixed inset-0 z-[60] bg-gray-50 dark:bg-[#0f0a1e] flex flex-col animate-in slide-in-from-right-full duration-300">
      <div className="bg-white/80 dark:bg-[#1a1429]/80 backdrop-blur-md border-b border-gray-100 dark:border-white/10 sticky top-0 z-10">
        <div className="max-w-lg mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <h2 className="font-bold text-gray-900 dark:text-white text-base font-[family-name:var(--font-display)]">{title}</h2>
        </div>
      </div>
  ...
  return (
    <div className={`${display.variable} ${body.variable} min-h-screen bg-gray-50 dark:bg-[#0f0a1e] transition-colors duration-300 pb-10 font-[family-name:var(--font-body)]`}>
      ...
      <div className="bg-white/80 dark:bg-[#1a1429]/80 backdrop-blur-md border-b border-gray-100 dark:border-white/10 sticky top-0 z-30">
        <div className="max-w-lg mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <h1 className="font-bold text-gray-900 dark:text-white text-base font-[family-name:var(--font-display)]">Settings</h1>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-[#1a1429]/70 dark:backdrop-blur-md rounded-2xl border border-gray-100 dark:border-white/[0.08] p-4 flex items-center gap-3.5">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              <p className="font-bold text-gray-900 dark:text-white text-base leading-none truncate font-[family-name:var(--font-display)]">
                {user ? username : "Guest"}
              </p>
          ...
          {user && !isPro && (
            <Link
              href="/upgrade"
              className="shrink-0 inline-flex items-center gap-1 text-[11px] font-bold text-blue-500 hover:text-blue-600 transition bg-blue-500/10 px-2 py-0.5 rounded-full"
            >
          ...
          <SettingsSection label="Subscription">
            {isPro && subscription ? (
              ...
              <SettingsRow
                ...
                sublabel="Verified badge, 2× Stars, reveal senders & more"
                href="/upgrade"
              />
            )}
          </SettingsSection>
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
          <div className="bg-white dark:bg-[#1a1429] rounded-3xl shadow-2xl border border-red-100 dark:border-red-500/20 w-full max-w-sm p-7 animate-in zoom-in-95 duration-200">
            ...
            <h2 className="text-lg font-black text-center text-gray-900 dark:text-white mb-1 font-[family-name:var(--font-display)]">Delete account?</h2>
