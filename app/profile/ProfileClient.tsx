                                        ...
                                        {filteredFriends.map(f => (
                                            <div key={f.id} className="flex items-center gap-3 p-3 sm:p-4 hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors rounded-xl">
                                                ...
                                                <button
                                                    ...
                                                    className="px-4 py-2 bg-slate-100 hover:bg-purple-100 text-slate-900 hover:text-purple-700 dark:bg-white/10 dark:hover:bg-purple-500/20 dark:text-white dark:hover:text-purple-300 font-bold rounded-xl text-sm transition-colors flex items-center justify-center gap-2 flex-shrink-0"
                                                >
