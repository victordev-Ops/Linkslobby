...
import { ArrowLeft, Save, Copy, Check, Loader2, User as UserIcon, XCircle, CheckCircle, Camera, UserPlus, UserMinus, Users, X, Clock, BadgeCheck, Send, ChevronDown, Search } from 'lucide-react'
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FD] dark:bg-[#0f0a1e] transition-colors duration-300 pb-24">
            ...
            <main className="max-w-2xl mx-auto px-0 sm:px-4 -mt-16 relative z-10 space-y-6">
                ...
                {/* Friends Section — grouped into a single collapsible card */}
                <div className="px-4 sm:px-0">
                    <div className="bg-white dark:bg-[#1a1429]/60 dark:backdrop-blur-xl sm:rounded-3xl shadow-sm border-y sm:border border-slate-200 dark:border-white/10 overflow-hidden">
                        ...
                        >
                            ...
                            <h3 className="font-bold text-slate-900 dark:text-white text-base flex-1 min-w-0">
                                Friends
                                {friends.length > 0 && (
