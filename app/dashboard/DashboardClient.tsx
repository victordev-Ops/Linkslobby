...
export default function DashboardClient({ initialDykmQuestions, serverProfile }: DashboardClientProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FD]">
      {/* Navbar */}
      <nav className={`bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 transition-opacity duration-200 ${isDykmModalOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
          ...
          <div className="text-center">
            ...
            <div className="flex items-center gap-2 p-1.5 bg-slate-50 border border-slate-200 rounded-2xl max-w-sm mx-auto">
              ...
              <button
                ...
                className={`shrink-0 w-10 h-10 flex items-center justify-center rounded-xl transition-all active:scale-90 ${heroCopied ? "bg-green-500 text-white" : "bg-slate-600 text-white hover:bg-slate-700"}`}
              >
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm transition-all overflow-hidden">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <h3 className="font-bold text-slate-900 text-base">Hot Seat</h3>
                    <div className="relative">
                      {/* Beeping animation */}
                  ...
                  <p className="text-slate-400 text-xs line-clamp-1">Answer rapid-fire questions under pressure</p>
                </div>
                <ChevronDown size={18} className={`text-slate-300 transition-transform duration-300 ${isHotSeatOpen ? "rotate-180" : ""}`} />
              </div>
