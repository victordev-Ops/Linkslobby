...
export default function DashboardClient({ initialDykmQuestions, serverProfile }: DashboardClientProps) {
    ...
    <div className={`${display.variable} ${body.variable} min-h-screen bg-[#F8F9FD] dark:bg-[#0f0a1e] transition-colors duration-300 pb-24 font-[family-name:var(--font-body)]`}>
      ...
      <nav className={`bg-white/80 dark:bg-[#1a1429]/80 backdrop-blur-md border-b border-slate-200 dark:border-white/10 sticky top-0 z-30 transition-all duration-200 ${isDykmModalOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          {/* Brand mark — transparent-background logo, swapped per color
              scheme so the wordmark stays legible on both navbars */}
          <div className="shrink-0">
            <img
              src="/linkslobby-logo-light.png"
              alt="linkslobby"
              className="h-6 sm:h-7 w-auto object-contain block dark:hidden"
            />
            <img
              src="/linkslobby-logo-dark.png"
              alt="linkslobby"
      ...
      <main className="max-w-xl mx-auto px-4 py-8 space-y-8 relative z-10">
        ...
        <header className="py-2 animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          <p className="text-slate-500 dark:text-white/60 text-sm font-medium">
            Pick a game, invite friends, see what happens.
          </p>
        </header>
              ...
              {isTodOpen && (
                <div className="px-4 pb-5 pt-1 space-y-4 animate-in slide-in-from-top-2 duration-300">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-rose-600 text-white font-bold rounded-xl text-xs hover:bg-rose-700 transition-all active:scale-95 hover:scale-[1.02] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                ...
                <div className="px-4 pb-5 pt-1 space-y-4 animate-in slide-in-from-top-2 duration-300">
                  ...
                  {!hasDykm ? (
                    <button
                      ...
                      className="w-full py-3 bg-blue-600 text-white font-bold rounded-xl text-xs hover:bg-blue-700 transition-all active:scale-95 hover:scale-[1.02]"
                    >
                      Create My Quiz
                    </button>
                  ) : (
              ...
              {isHotSeatOpen && (
                <div className="px-4 pb-5 pt-1 space-y-4 animate-in slide-in-from-top-2 duration-300">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-amber-600 text-white font-bold rounded-xl text-xs hover:bg-amber-700 transition-all active:scale-95 hover:scale-[1.02] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
              ...
              {isRpsOpen && (
                <div className="px-4 pb-5 pt-1 space-y-4 animate-in slide-in-from-top-2 duration-300">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-emerald-600 text-white font-bold rounded-xl text-xs hover:bg-emerald-700 transition-all active:scale-95 hover:scale-[1.02] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                  ...
                  {isThreeWordOpen && (
                    <div className="px-4 pb-5 pt-1 space-y-4 animate-in slide-in-from-top-2 duration-300">
                      ...
                      <button
                        ...
                        className="w-full py-3 bg-cyan-600 text-white font-bold rounded-xl text-xs hover:bg-cyan-700 transition-all active:scale-95 hover:scale-[1.02] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                      >
                  ...
                  {isScrambleOpen && (
                    <div className="px-4 pb-5 pt-1 space-y-4 animate-in slide-in-from-top-2 duration-300">
                      ...
                      <button
                        ...
                        className="w-full py-3 bg-violet-600 text-white font-bold rounded-xl text-xs hover:bg-violet-700 transition-all active:scale-95 hover:scale-[1.02] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                      >
  ...
  <div className="w-14 h-14 mx-auto rounded-2xl bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center mb-5 ring-8 ring-blue-50/50 dark:ring-blue-500/10">
