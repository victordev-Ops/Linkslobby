            ...
            <div className="relative z-10 px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-10">
                        {/* 1. Joined Lobbies — Horizontal Scroll */}
                                ...
                                <div className="flex overflow-x-auto pb-3 gap-3 snap-x snap-mandatory no-scrollbar -mx-4 px-4">
                                    ...
                                    {hasMorePrivate && (
                                        <button
                                            ...
                                            className="snap-center shrink-0 w-[120px] h-[160px] rounded-3xl bg-slate-900/30 border border-dashed border-slate-800 flex flex-col items-center justify-center gap-2 text-slate-500 hover:text-slate-300 transition-all font-bold"
                                        >
                                            {isLoadingMorePrivate ? <Loader2 size={20} className="animate-spin" /> : <Plus size={20} />}
                                ...
                                <div className="flex overflow-x-auto pb-3 gap-3 snap-x snap-mandatory no-scrollbar -mx-4 px-4">
                                    ...
                                    {hasMorePublic && (
                                        <button
                                            ...
                                            className="snap-center shrink-0 w-[120px] h-[160px] rounded-3xl bg-slate-900/40 border border-dashed border-slate-800/60 text-slate-500 font-bold hover:bg-slate-800/60 transition-all flex flex-col items-center justify-center gap-2 group disabled:opacity-50"
                                        >
